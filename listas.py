...
contrato_observacoes = [
    "Cliente quer Wi-Fi potente em toda casa.",
    "Cliente precisa de velocidade constante, sem quedas.",
    "Cliente quer ajuda 24/7 para resolver problemas de conexão.",
    "Cliente pensa em adicionar TV ou telefone depois.",
    "Cliente quer saber antes de qualquer manutenção na rede.",
    "Cliente quer faturas detalhadas todo mês.",
    "Cliente exige segurança online forte.",
